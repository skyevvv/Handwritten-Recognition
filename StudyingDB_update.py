...
class LearningDB():
    ...
    def __init__(self):
        self.conn = pymssql.connect(host='DESKTOP-4GTE14F',user='sa',password='123456',database='PyLearningDB',charset='utf8')
    ...
    def __get_data(self, table, test_data):
        ...
        try:
            ...
            self.conn = pymssql.connect(host='DESKTOP-4GTE14F',
                                        user='sa',
                                        password='123456',
